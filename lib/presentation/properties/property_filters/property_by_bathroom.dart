...
class PropertyByBathroom extends StatefulWidget {
  const PropertyByBathroom({Key? key}) : super(key: key);

  @override
  State<PropertyByBathroom> createState() => _PropertyByBathroomState();
}

class _PropertyByBathroomState extends State<PropertyByBathroom> {
            ...
            children: <Widget>[
              ...
              SizedBox(
                  ...
                  child: YouOnlineNumberField(
                      onChanged: (val) {
                        setState(() {
                          propertiesViewModel.propertyFilterData!.baths = int.parse(val);
                        });
                      },
